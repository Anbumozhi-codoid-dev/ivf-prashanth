...
return remainingTime.toString();
        ...
        listener: (context,state){
          ...
          if(state is GetCheckInStatusSuccessState){
            ...
            if(state.data['data'].isNotEmpty){
              ...
              isCheckIn = state.data['data'].toString().contains("check_in") ? state.data['data']['check_in'] : false;
              print("shiftData====");
              print(shiftData!.fromTime);
              print(shiftData!);
              ...
              child: Padding(
                ...
                Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                CommonUI().myText(text: _employeeData!.userData.firstName.substring(0)[0].toUpperCase() + _employeeData!.userData.firstName.substring(1) ,fontWeight: FontWeight.w500 ,fontSize: 14.sp,letterSpacing: 0.1),
                                Gap(10),
                    ...
                    Gap(5.h),
                    shiftData !=null ?
                    shiftData!.shiftName =="weekoff"?
                    CommonUI().myText(text: shiftData!.currentDate.toString().split(' ')[0]==DateTime.now().toString().split(' ')[0] ? "Today WeekOff" :'${shiftData!.currentDate} on shift',fontWeight: FontWeight.w600,fontSize: 13.sp)
                    :

                    Row(
                      children: [
                        Gap(2.w),
                        CommonUI().myText(text: shiftData!.currentDate.toString().split(' ')[0]==DateTime.now().toString().split(' ')[0] ? "Today " :'${shiftData!.currentDate.toString().split(" ")[0]}',fontWeight: FontWeight.w600,fontSize: 13.sp),
                     Gap(1.w),
                      CommonUI().myText(text: shiftData!.shiftName,fontWeight: FontWeight.w600,fontSize: 13.sp),],
                    ): SizedBox()
                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    shiftData!.shiftName =="weekoff"?
                                    SizedBox():
                                    CommonUI().verticleAlign(width: 5.w),
                                    shiftData!.shiftName =="weekoff"?
                                    CommonUI().myText(
                                        text: "WeekOff",
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    // FutureBuilder(
                                    //   future: calculateTimeLeft(),
                                    //
                                    //     builder: (context,snapshot){
                                    //   return  CommonUI().myText(
                              ...
                              shiftData!.shiftName =="weekoff"?
                                  SizedBox():
                              shiftData!.currentDate.toString().split(' ')[0]==DateTime.now().toString().split(' ')[0]
                              ?
                              CommonUI.buttonContainer(
                                  height: 4.h,
                                  width: 70.w,
                                                     ...
                                                     TextButton(
                                                       onPressed: () {
                                                         ...
                                                         String currentTime;
                                                          ...
                                                          print(currentTime);
                                                          var payload=CheckOut(date:  DateTime.now().toString().split(" ")[0],
                                                              year: DateTime.now().year.toString(), month: DateTime.now().month.toString(),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        CommonUI().myText(text: _employeeData != null ? _employeeData!.userData.firstName.toString() : "-",fontWeight: FontWeight.w500 ,fontSize: 14.sp,letterSpacing: 0.1),
                        Gap(10),
                        CommonUI().myText(text: _employeeData != null ? _employeeData!.userData.userRole.description.toString() : "-",fontWeight: FontWeight.w600 ,fontSize: 10.sp,letterSpacing: 0.1,color: AppTheme.primaryColor2),
                      ],
                    ),
                  ],
                )
               ...
               // width: 95.w,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _employeeData != null ?  CommonUI().myText(text: "Name :  ${_employeeData!.userData.firstName}") : CommonUI().myText(text: "-"),
                      Gap(2.h),
                      _employeeData != null ?  CommonUI().myText(text: "Job : ${_employeeData!.userData.userRole.description}") : CommonUI().myText(text: "-"),
                      Gap(2.h),
                      _employeeData != null ?  CommonUI().myText(text: "Salary: ${_employeeData!.offerLetter.grossSalary}") : CommonUI().myText(text: "-"),
                      Gap(2.h),
                      Row(
                        mainAxisAlignment:MainAxisAlignment.end,
                        children: [
  ...
  // Future<Duration> calculateTimeLeft() async {
  //   DateTime now = DateTime.now();
  //   Duration timeDifference = shiftDateTime.difference(now);
