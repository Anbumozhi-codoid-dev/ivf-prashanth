...
abstract class AppTheme{
  ...
  static const Color lopColor = Color(0xFFF47F39);
  static const Color personalLeaveColor = Color(0xFFF0EB5E);
  static const Color casualLeaveColor = Color(0xFFD8F64E);
